...
public class ResumeTestData {
    public static Resume getInstance(String uuid, String fullName) {
        ...
        Organization org1 = new Organization("Org1", "org1.com",
                new Organization.Period(YearMonth.of(2018, 1), YearMonth.of(2018, 5),
        ...
        Organization org2 = new Organization("Org2", "org2.com",
                new Organization.Period(YearMonth.of(2019, 2), YearMonth.of(2019, 8),
        ...
        Organization ed1 = new Organization("ed1", "ed1.com",
                new Organization.Period(YearMonth.of(2018, 1), YearMonth.of(2018, 5),
                        "ed1 period1 title", "ed1 period1 " + "description"),
                new Organization.Period(YearMonth.of(2018, 6), YearMonth.of(2019, 1),
                        "ed1 period2 title", "ed1 " + "period2 description"));
        Organization ed2 = new Organization("ed2", "ed2.com",
                new Organization.Period(YearMonth.of(2019, 2), YearMonth.of(2019, 8),
